		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#hudlvinvoicesmodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"hudlvinvoicesmodule-display": {
								"semanticObject": "hudlvinvoicesmodule",
								"action": "display",
								"description": "Invoices - A Fiori application.",
								"title": "Invoices application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=hu.dlv.invoicesmodule",
									"url": sap.ui.require.toUrl("hu/dlv/invoicesmodule")
								}
							}
						}
					}
